//
//  UT_MoonUseSameTimeZone.swift
//  
//
//  Created by Davide Biancardi on 25/03/23.
//
...
final class UT_MoonUseSameTimeZone: XCTestCase {
    ...
    func testOfMoon() throws {
        ...
        var moonUnderTest = Moon.init(location: UT_MoonUseSameTimeZone.naplesLocation, timeZone: Double(UT_MoonUseSameTimeZone.timeZoneNaples),useSameTimeZone: true)
        ...
        XCTAssertTrue(abs(expectedMoonPercentage - moonUnderTest.moonPercentage) <  UT_MoonUseSameTimeZone.moonPercentageThreshold)
        XCTAssertTrue(abs(expectedAzimuth - moonUnderTest.azimuth) <  UT_MoonUseSameTimeZone.moonAzimuthThreshold)
        XCTAssertTrue(abs(expectedAltitude - moonUnderTest.altitude) <  UT_MoonUseSameTimeZone.moonAltitudeThreshold)
        XCTAssertTrue(abs(expectedMoonRise.timeIntervalSince1970 - moonUnderTest.moonRise!.timeIntervalSince1970) <  UT_MoonUseSameTimeZone.moonSetRiseThresholdInSeconds)
        XCTAssertTrue(abs(expectedMoonset.timeIntervalSince1970 - moonUnderTest.moonSet!.timeIntervalSince1970) <  UT_MoonUseSameTimeZone.moonSetRiseThresholdInSeconds)
        
        XCTAssertTrue(abs(expectedNextFullMoon - moonUnderTest.nextFullMoon) < UT_MoonUseSameTimeZone.nextNewMoonAndFullMoonThreshold)
        XCTAssertTrue(abs(expectedNextNewMoonInDays - moonUnderTest.nextNewMoon) < UT_MoonUseSameTimeZone.nextNewMoonAndFullMoonThreshold)
        
        //Test2: 2/11/22 09:31. Timezone +1. (No daylight saving). Moonset shall be NIL in this test
        
        //Step1: Creating moon instance in Naples and with timezone +1
        moonUnderTest = Moon.init(location: UT_MoonUseSameTimeZone.naplesLocation, timeZone: Double(UT_MoonUseSameTimeZone.timeZoneNaples),useSameTimeZone: true)
        ...
        moonUnderTest = Moon.init(location: UT_MoonUseSameTimeZone.tokyoLocation, timeZone: Double(UT_MoonUseSameTimeZone.timeZoneTokyo),useSameTimeZone: true)
        ...
        moonUnderTest = Moon.init(location: UT_MoonUseSameTimeZone.louisaLocation, timeZone: Double(UT_MoonUseSameTimeZone.timeZoneLouisa),useSameTimeZone: true)
        ...
        moonUnderTest = Moon.init(location: UT_MoonUseSameTimeZone.tromsoLocation, timeZone: Double(UT_MoonUseSameTimeZone.timeZoneTromso),useSameTimeZone: true)
        ...
        moonUnderTest = Moon.init(location: UT_MoonUseSameTimeZone.tromsoLocation, timeZone: Double(UT_MoonUseSameTimeZone.timeZoneTromsoDaylightSaving),useSameTimeZone: true)
        ...
        moonUnderTest = Moon.init(location: UT_MoonUseSameTimeZone.bainbridgeLocation, timeZone: Double(UT_MoonUseSameTimeZone.timeZoneBainbridge),useSameTimeZone: true)
